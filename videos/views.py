...
def Videos(req):
    ...
    Name = 'Mudasir Ali'
    Titles = ['', 'Input Animation With HTML & CSS',
              'Instagram Login Automation With Python & Selenium ', 'This Bot will get FOLLOWERS for you. ']
    ...
    Thumbnails = {'MudasirAli': 'Pics/my-pic.jpg',
                  'Video_1': 'Pics/Pages/Videos/input_animation_with_html_and_css.jpg', 'Video_2': 'Pics/Pages/Videos/instagram_login_automation.png', 'Video_3': 'Pics/Pages/Videos/this_bot_will_get_followers_for_you.png', }
    Dates = {'Video_1': 'Aug 14, 2020', 'Video_2': 'Sep 1, 2020', 'Video_3': 'Sep 6, 2020'}
    Links = {'Video_1': 'Video_1',
             'Video_2': 'Video_2', 'Video_3': 'Video_3'}
