...
urlpatterns = [
    ...
    path('10-most-popular-programming-Languages-and-their-uses-2020-october/', views.Post_6, name='10_most_popular_programming_Languages_and_their_uses_2020_october'),
