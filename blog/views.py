...
Dates = {'Post_1': '13 Aug, 2020', 'Post_2': '21 Aug, 2020', 'Post_3': '23 Aug, 2020', 'Post_4': '5 Sep, 2020', 'Post_5': '30 Sep, 2020'}
...
def Blogs(req):
    return render(req, 'Pages/Blogs.html', {'recent_post_1_title': Recent_Posts_Titles[0],
                                            ...
                                            'aboutme': AboutMe,
                                            'post_1_tittle': Tittles[1], 'post_2_tittle': Tittles[2], 'post_3_tittle': Tittles[3], 'post_4_tittle': Tittles[4], 'post_5_tittle': Tittles[5], 
                                            'post_1_desc': Descriptions.get('Post_1'), 'post_2_desc': Descriptions.get('Post_2'), 'post_3_desc': Descriptions.get('Post_3'), 'post_4_desc': Descriptions.get('Post_4'), 'post_5_desc': Descriptions.get('Post_5'),
                                            'post_1_date': Dates.get('Post_1'), 'post_2_date': Dates.get('Post_2'), 'post_3_date': Dates.get('Post_3'), 'post_4_date': Dates.get('Post_4'), 'post_5_date': Dates.get('Post_5'),
                                            'post_1_thumb': Thumbnails.get('Post_1'), 'post_2_thumb': Thumbnails.get('Post_2'), 'post_3_thumb': Thumbnails.get('Post_3'), 'post_4_thumb': Thumbnails.get('Post_4'), 'post_5_thumb': Thumbnails.get('Post_5'),
                                            'post_1_link': Links.get('Post_1'), 'post_2_link': Links.get('Post_2'), 'post_3_link': Links.get('Post_3'), 'post_4_link': Links.get('Post_4'),  'post_5_link': Links.get('Post_5'),  
                                            })
